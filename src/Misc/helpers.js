export function CalculateTargetSquare(initialSquare, xOffset, yOffset) {
    var squareWidth = document.getElementsByClassName('blackSquare')[0].offsetWidth;
    var letters = [ 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h' ];
    var numbers = [ '1', '2', '3', '4', '5', '6', '7', '8' ];
    return letters[letters.indexOf(initialSquare[0]) + (Math.round(xOffset / squareWidth))] + numbers[numbers.indexOf(initialSquare[1]) - (Math.round(yOffset / squareWidth))]
}
