...
class Piece extends React.Component{
  ...
  PieceCanMove(){
    if (this.props.analysisMode) {
      return true;
    } else if(!this.props.resigned && this.props.whiteAtBottom && this.props.pieceColor === 'w'){
      return true;
...
class WhiteAtBottomBoard extends Component {
  renderSquare(piece, color, coordinate){
    ...
    return <Square coordinate={coordinate} picture={piecesPictures[piece]} color={color} onClick={this.props.onClick} onMouseUp={this.props.onMouseUp} whiteIsNext={this.props.whiteIsNext} availableMoves={this.props.availableMoves} whiteAtBottom={true} resigned={this.props.resigned} analysisMode={this.props.analysisMode}/>
  }
...
class BlackAtBottomBoard extends Component {
  renderSquare(piece, color, coordinate){
    const piecesPictures = this.props.piecesPictures;
    return <Square coordinate={coordinate} picture={piecesPictures[piece]} color={color} onClick={this.props.onClick} onMouseUp={this.props.onMouseUp} whiteIsNext={this.props.whiteIsNext} availableMoves={this.props.availableMoves} whiteAtBottom={false} resigned={this.props.resigned} analysisMode={this.props.analysisMode}/>
  }
...
class Board extends Component {
  ...
  render() {
    return (
      this.props.whiteAtBottom ? <WhiteAtBottomBoard piecesPictures={this.piecesPictures} position={this.props.position} onClick={this.props.onClick} onMouseUp={this.props.onMouseUp} whiteIsNext={this.props.whiteIsNext} availableMoves={this.props.availableMoves} resigned={this.props.resigned} analysisMode={this.props.analysisMode}/> 
      : <BlackAtBottomBoard piecesPictures={this.piecesPictures} position={this.props.position} onClick={this.props.onClick} onMouseUp={this.props.onMouseUp} whiteIsNext={this.props.whiteIsNext} availableMoves={this.props.availableMoves} resigned={this.props.resigned} analysisMode={this.props.analysisMode}/>
    )
  }
